...
public class JsonRpc2Request extends AbstractJsonRpc2 {
    ...
    public JsonRpc2Request(final String method, final List<Object> params, final long id){
        setMethod(method);
        this.params = params;
        this.id = id;
    }
    ...
    /**
     * Check if JSON-RPC-Request object ist valid.
     * To be valid JSON-RPC version must be 2.0 and
     * method must not be null or empty string.
     *
    ...
    /**
     * Parse a string representation of a JSON-RPC 2.0 Request into a JsonRpc2Request object
     *
     * @param jsonInString String representation of a JSON-RPC 2.0 Request
     * @return JsonRpc2Request object
     */
    public static JsonRpc2Request parse(String jsonInString) {
        Gson gson = new Gson();
        JsonRpc2Request jsonObj = gson.fromJson(jsonInString, JsonRpc2Request.class);
        return jsonObj;
    }
     ...
     *
     * @param params parameters as object list.
     */
